						...
						<form class="form-horizontal" action="./php/addemployee.php" method="post">
							...
							<div class="col-lg-6">
								<div class="control-group">
							  		...
							  		<div class="controls">
							    		<input id="emp_password" name="emp_password" type="text" placeholder="Password" class="form-control" required="">						    
							  		</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="control-group">
							  		...
							  		<div class="controls">
							    		<input id="emp_conpassword" name="emp_conpassword" type="text" placeholder="confirm password" class="form-control" required="">						    
							  		</div>
								</div>
							</div>
